...
export function apply(ctx) {
    ...
    ctx.on('system-prompt/assemble', async (_assembly, context, next) => {
        ...
        try {
            ...
            applyStanding(result, state.pinStanding(agent.id, standingFingerprint(binding, { name: pipeline.userName, description: pipeline.personaDescription }, state.standingRevTags(binding, { personaLorebookId: pipeline.personaLorebookId })), standing));
