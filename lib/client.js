...
var METHODS = {
  ...
  saveJournal: { req: object({ ...cardIdField, text: string2() }), value: anyValue, summary: "\u4FDD\u5B58\u89D2\u8272\u7B14\u8BB0 journal.md" },
  // 人设
...
${log.lines.join("\n")}` : t2("chip.log.empty")
  ...
  return (0, import_jsx_runtime7.jsxs)("span", { className: "dsh-tavern-ui", style: { display: "inline-flex" }, children: [(0, import_jsx_runtime7.jsx)(TavernSeatChip, { label: binding ? name2 ?? listedName ?? t2("chip.characterFallback") : t2("hero.pickCharacter"), title: t2("hero.pickCharacter"), avatarUrl: avatar, open, loading: bindingLoader.state.status === "loading", hasPopup: "dialog", onClick: () => setOpen(!open) }), (0, import_jsx_runtime7.jsx)(Dialog, { open, title: t2("chip.dialog.title"), onClose: () => setOpen(false), width: "xl", footer: draft ? (0, import_jsx_runtime7.jsxs)("div", { className: "dsh-tavern-footActions", children: [binding ? (0, import_jsx_runtime7.jsx)(Btn, { danger: true, size: "md", onClick: () => {
    ...
    setChatLore(null);
  }, save: (json) => remote.saveChatLorebook({ cardId: chatLore.cardId, json }) }) }), (0, import_jsx_runtime7.jsx)(ConfirmDialog, { open: confirmUnbind, title: t2("chip.unbind.title"), description: t2("chip.unbind.desc"), confirmLabel: t2("chip.unbind.action"), danger: true, busy: unbindBusy, onCancel: () => {
    setConfirmUnbind(false);
...
function CharacterDetailDialog(props) {
  ...
  ] }) })] }) : null] })] }), (0, import_jsx_runtime9.jsxs)("div", { className: "dsh-tavern-panelCard", children: [(0, import_jsx_runtime9.jsx)("div", { className: "dsh-tavern-groupHead", children: t2("characters.detail.groupMetadata") }), (0, import_jsx_runtime9.jsx)(LabeledArea, { label: t2("characters.detail.creatorNotes"), value: detail.creatorNotes, onChange: (v) => set({ creatorNotes: v }) }), (0, import_jsx_runtime9.jsxs)("div", { className: "dsh-tavern-fieldRow", children: [(0, import_jsx_runtime9.jsx)(Field, { label: t2("characters.detail.creator"), children: (0, import_jsx_runtime9.jsx)("input", { className: "dsh-tavern-input", value: detail.creator, onChange: (e) => set({ creator: e.target.value }) }) }), (0, import_jsx_runtime9.jsx)(Field, { label: t2("characters.detail.version"), children: (0, import_jsx_runtime9.jsx)("input", { className: "dsh-tavern-input", value: detail.characterVersion, onChange: (e) => set({ characterVersion: e.target.value }) }) })] }), (0, import_jsx_runtime9.jsx)(Field, { label: t2("characters.detail.tags"), children: (0, import_jsx_runtime9.jsx)("input", { className: "dsh-tavern-input", style: { width: "100%" }, value: detail.tags.join(", "), onChange: (e) => set({ tags: e.target.value.split(/[，,]/).map((s) => s.trim()).filter(Boolean) }) }) })] }), (0, import_jsx_runtime9.jsx)(Err, { message: error }), (0, import_jsx_runtime9.jsxs)("div", { className: "dsh-tavern-footActions", style: { marginTop: 2 }, children: [(0, import_jsx_runtime9.jsx)(IconBtn, { label: t2("characters.detail.exportPng"), onClick: () => void exportCard("png"), children: (0, import_jsx_runtime9.jsx)(import_dsh_client_ui_primitives9.IconDownloadOutline16, {}) }), interactiveHtml !== null && (0, import_jsx_runtime9.jsx)(Btn, { size: "md", onClick: () => setCardOpen(true), children: t2("interactive.open") }), (0, import_jsx_runtime9.jsx)("span", { className: "dsh-tavern-footSpacer" }), (0, import_jsx_runtime9.jsx)(Btn, { size: "md", disabled: busy, onClick: () => void exportCard("json"), children: t2("characters.detail.exportJson") }), (0, import_jsx_runtime9.jsx)(Btn, { primary: true, size: "md", disabled: busy, onClick: () => void save(), children: t2("action.save") })] })] }), cardOpen && interactiveHtml !== null && (0, import_jsx_runtime9.jsx)(Dialog, { open: true, width: "lg", title: t2("characters.detail.interactiveTitle", { name: detail?.name ?? "" }), onClose: () => setCardOpen(false), children: (0, import_jsx_runtime9.jsx)("iframe", { sandbox: "allow-scripts", srcDoc: withCsp(interactiveHtml), title: t2("characters.detail.interactiveFrame"), style: { width: "100%", height: "60vh", border: "1px solid var(--dsw-alias-border-l2, rgba(128,128,128,.25))", borderRadius: 16, background: "var(--dsw-alias-bg-base, #111)" } }) })] });
}
...
function RegexSection(props) {
  ...
  return (0, import_jsx_runtime14.jsxs)(Section, { title: t2("section.regex"), children: [toast.node, (0, import_jsx_runtime14.jsx)(Muted, { children: t2("regex.desc") }), state.status === "loading" && (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [(0, import_jsx_runtime14.jsx)(Skeleton, { height: 72 }), (0, import_jsx_runtime14.jsx)(Skeleton, { height: 72 }), (0, import_jsx_runtime14.jsx)(Skeleton, { height: 72 })] }), state.status === "error" && (0, import_jsx_runtime14.jsx)(Err, { message: state.message }), (0, import_jsx_runtime14.jsx)(Err, { message: error }), rules !== null && (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [current2.map((rule, i) => (0, import_jsx_runtime14.jsx)(RuleEditor, { rule, onChange: (r) => {
