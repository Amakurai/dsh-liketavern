...
function SpeechBubbleSession(props) {
  ...
  const frames = htmls.map((html, i) => {
    const srcDoc = buildCardSrcDoc(html, {
      greetings,
      greetingIndex,
...
function TavernAssistantNode(props) {
  ...
  if (binding && text && !hasImages) {
    return (0, import_jsx_runtime6.jsxs)("div", { children: [(0, import_jsx_runtime6.jsx)(ReasoningFold, { text: reasoningText, streaming }), (0, import_jsx_runtime6.jsx)(SpeechBubble, { remote, sessionId, cardId: binding.cardId, name: name2 || t2("assistant.characterFallback"), rawText: text, streaming, interactiveCards: binding.interactiveCards, onSwipeGreeting: async (index) => {
      if (!sessions)
