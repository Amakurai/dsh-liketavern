...
export function TavernInterruptedFloorActions(props) {
    ...
    return (_jsxs("span", { className: "dsh-tavern-actionGroup dsh-tavern-actionGroup-interrupted", children: [siblingSwipe && siblingSwipe.total > 1 && (_jsxs(_Fragment, { children: [_jsx(IconAction, { label: t('actions.branchPrev'), disabled: busy, busy: operation === 'branch-prev', onClick: () => onBranch(-1), children: _jsx(IconChevronLeftOutline14, {}) }), _jsxs("span", { className: "dsh-tavern-swipeIdx", title: t('actions.branchCount', { turn: siblingSwipe.turn, total: siblingSwipe.total }), children: [siblingSwipe.index + 1, "/", siblingSwipe.total] }), _jsx(IconAction, { label: t('actions.branchNext'), disabled: busy, busy: operation === 'branch-next', onClick: () => onBranch(1), children: _jsx(IconChevronRightOutline14, {}) }), _jsx("span", { className: "dsh-tavern-actionDivider" })] })), _jsx(IconAction, { label: t('actions.regenerate'), disabled: busy, busy: operation === 'regenerate', onClick: () => void run('regenerate', () => remote.regenerate({ sessionId, turn })), children: _jsx(IconRefreshOutline16, {}) }), _jsx(IconAction, { label: t('actions.rollback'), disabled: busy, busy: operation === 'rollback', onClick: () => void run('rollback', () => remote.rollbackToFloor({ sessionId, turn })), children: _jsx(IconBranchOutline16, {}) }), failure !== null && (_jsx("span", { role: "status", style: { fontSize: 12, color: 'var(--dsw-alias-state-error-primary, #ec1313)', paddingLeft: 4 }, children: failure })), toast.node] }));
}
