...
function PromptPreviewDialog(props) {
    ...
    return (_jsxs(Dialog, { open: true, title: "\u63D0\u793A\u8BCD\u9884\u89C8", onClose: props.onClose, width: "lg", children: [_jsxs(Muted, { children: ["\u4E16\u754C\u4E66\u9884\u7B97 ", wi.used, "/", wi.limit, wi.overflowed ? ' · 已溢出' : '', ' · ', "\u7EC4\u88C5 ", assemble.tokensAfter, "/", assemble.tokensBefore, " token", assemble.trimmedSections.length > 0 ? ` · 裁剪 ${assemble.trimmedSections.join('、')}` : ''] }), _jsxs("div", { className: "dsh-tavern-filters", style: { margin: '10px 0 12px' }, children: [[
                        ['standing', 'standing'],
                        ['turn', '本轮 turn'],
                        ['full', '完整序列'],
                        ['log', '触发日志'],
                    ].map(([id, label]) => (_jsx("button", { type: "button", className: "dsh-tavern-chip", "data-active": tab === id ? 'true' : 'false', onClick: () => setTab(id), children: label }, id))), _jsx("span", { style: { flex: 1 } }), _jsx(IconBtn, { label: "\u590D\u5236\u5F53\u524D\u89C6\u56FE", onClick: () => void copyBody(), children: _jsx(IconCopyOutline16, {}) })] }), _jsx("pre", { className: "dsh-tavern-modalPre", children: body }), toast.node] }));
}
export function TavernHeaderChip(props) {
    ...
    return (_jsxs("span", { className: "dsh-tavern-ui", style: { display: 'inline-flex' }, children: [_jsx(TavernSeatChip, { label: binding ? (name ?? listedName ?? '角色') : '选择角色卡', title: "\u9009\u62E9\u89D2\u8272\u5361", avatarUrl: avatar, open: open, hasPopup: "dialog", onClick: () => setOpen(!open) }), _jsx(Dialog, { open: open, title: "Tavern \u7ED1\u5B9A", onClose: () => setOpen(false), width: "xl", children: _jsxs("div", { className: "dsh-tavern-binding", children: [_jsx(Err, { message: error }), !lists && (_jsxs("div", { className: "dsh-tavern-panelCard", children: [_jsx(Skeleton, { height: 14, width: "24%" }), _jsx(Skeleton, { height: 38, radius: 18 }), _jsx(Skeleton, { height: 38, radius: 18 }), _jsx(Skeleton, { height: 38, radius: 18 })] })), lists && (_jsxs(_Fragment, { children: [draft ? (_jsxs(_Fragment, { children: [_jsxs("div", { className: "dsh-tavern-panelCard", children: [_jsx("div", { className: "dsh-tavern-groupHead", children: "\u7ED1\u5B9A" }), _jsx(Field, { label: "\u89D2\u8272", children: _jsx(Select, { width: "100%", value: draft.cardId, onChange: (cardId) => {
                                                        ...
                                                        ] }) }), _jsx(Field, { label: "\u9884\u8BBE", children: _jsx(Select, { width: "100%", value: draft.presetId ?? '', onChange: (v) => setDraft({ ...draft, presetId: v || null }), options: [{ value: '', label: '（内建默认）' }, ...lists.presets.map((p) => ({ value: p.id, label: p.regexCount > 0 ? `${p.name}（${p.regexCount} 条正则）` : p.name }))] }) }), _jsx(Field, { label: "\u4EBA\u8BBE", children: _jsx(Select, { width: "100%", value: draft.personaId ?? '', onChange: (v) => setDraft({ ...draft, personaId: v || null }), options: [{ value: '', label: '（无）' }, ...lists.personas.map((p) => ({ value: p.id, label: p.name }))] }) })] }), _jsxs("div", { className: "dsh-tavern-panelCard", children: [_jsx("div", { className: "dsh-tavern-groupHead", children: "\u4E16\u754C\u4E66" }), _jsx(Field, { label: "\u4E3B\u4E16\u754C\u4E66", children: _jsx(Select, { width: "100%", value: draft.characterLorebookId ?? '', onChange: (v) => setDraft({ ...draft, characterLorebookId: v || null }), options: [
                                                            { value: '', label: embeddedBookLabel },
                                                            ...lists.lorebooks.map((n) => ({ value: n, label: n })),
                                                        ] }) }), _jsx(Field, { label: "\u5168\u5C40\u4E16\u754C\u4E66\uFF08\u591A\u9009\uFF09", children: lists.lorebooks.length === 0 ? (_jsx(Muted, { children: "\u5E93\u4E2D\u6682\u65E0\u4E16\u754C\u4E66" })) : (_jsx(CheckChips, { ariaLabel: "\u5168\u5C40\u4E16\u754C\u4E66", options: lists.lorebooks.map((n) => ({ value: n, label: n })), selected: draft.lorebookIds, onChange: (lorebookIds) => setDraft({ ...draft, lorebookIds }) })) })] }), _jsxs("div", { className: "dsh-tavern-panelCard", children: [_jsx("div", { className: "dsh-tavern-groupHead", children: "\u672C\u8F6E\u6CE8\u5165" }), _jsx(Field, { label: "\u4F5C\u8005\u6CE8\u91CA\uFF08\u672C\u4F1A\u8BDD\uFF0C\u8FDB\u672C\u8F6E turn\uFF09", children: _jsx("textarea", { className: "dsh-tavern-input dsh-tavern-textarea", style: { minHeight: 96 }, value: draft.authorNote ?? '', onChange: (e) => setDraft({ ...draft, authorNote: e.target.value }) }) }), _jsx("div", { className: "dsh-tavern-inlineChecks", children: _jsxs("label", { children: [_jsx(Toggle, { checked: draft.injectJournal === true, onChange: (injectJournal) => setDraft({ ...draft, injectJournal }) }), "\u6CE8\u5165\u89D2\u8272\u7B14\u8BB0 journal.md"] }) })] }), _jsxs("div", { className: "dsh-tavern-footActions", children: [binding ? (_jsx(Btn, { danger: true, size: "md", onClick: () => {
                                                        setConfirmUnbind(true);
                                                    }, children: "\u89E3\u9664\u7ED1\u5B9A" })) : null, _jsx("span", { className: "dsh-tavern-footSpacer" }), _jsx(Btn, { size: "md", onClick: () => void openChatLore(), children: "\u7F16\u8F91\u672C\u4F1A\u8BDD\u4E16\u754C\u4E66" }), _jsx(Btn, { primary: true, size: "md", onClick: () => void saveBinding(), children: "\u4FDD\u5B58\u7ED1\u5B9A" })] })] })) : (_jsxs("div", { className: "dsh-tavern-panelCard", children: [_jsx("div", { className: "dsh-tavern-groupHead", children: "\u7ED1\u5B9A" }), _jsx(Field, { label: "\u89D2\u8272", children: _jsx(Select, { width: "100%", value: "", onChange: (cardId) => {
                                                    if (!cardId)
                                                        return;
