...
function PromptPreviewDialog(props) {
    ...
    return (_jsxs(Dialog, { open: true, title: t('chip.preview.title'), onClose: props.onClose, width: "lg", children: [_jsxs(Muted, { children: [t('chip.preview.budget', { used: wi.used, limit: wi.limit }), wi.overflowed ? ` · ${t('chip.preview.overflowed')}` : '', ' · ', t('chip.preview.assemble', { after: assemble.tokensAfter, before: assemble.tokensBefore }), assemble.trimmedSections.length > 0
                        ...
                        : ''] }), _jsxs("div", { className: "dsh-tavern-filters", style: { margin: '10px 0 12px' }, children: [[
                        ['standing', 'standing'],
                        ['turn', t('chip.preview.tab.turn')],
                        ['full', t('chip.preview.tab.full')],
                        ['log', t('binding.triggerLog')],
                    ].map(([id, label]) => (_jsx("button", { type: "button", className: "dsh-tavern-chip", "data-active": tab === id ? 'true' : 'false', onClick: () => setTab(id), children: label }, id))), _jsx("span", { style: { flex: 1 } }), _jsx(IconBtn, { label: t('chip.preview.copyView'), onClick: () => void copyBody(), children: _jsx(IconCopyOutline16, {}) })] }), _jsx("pre", { className: "dsh-tavern-modalPre", children: body }), toast.node] }));
}
