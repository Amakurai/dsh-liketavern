...
export function TavernHeaderChip(props) {
    ...
    return (_jsxs("span", { className: "dsh-tavern-ui", style: { display: 'inline-flex' }, children: [_jsx(TavernSeatChip, { label: binding ? (name ?? listedName ?? '角色') : '选择角色卡', title: "\u9009\u62E9\u89D2\u8272\u5361", avatarUrl: avatar, open: open, hasPopup: "dialog", onClick: () => setOpen(!open) }), _jsx(Dialog, { open: open, title: "Tavern \u7ED1\u5B9A", onClose: () => setOpen(false), width: "lg", children: _jsxs("div", { className: "dsh-tavern-binding", children: [_jsx(Err, { message: error }), !lists && (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: 8 }, children: [_jsx(Skeleton, { height: 18 }), _jsx(Skeleton, { height: 18 })] })), lists && (_jsxs(_Fragment, { children: [_jsx(Field, { label: "\u89D2\u8272", children: _jsx(Select, { width: "100%", value: draft?.cardId ?? '', onChange: (cardId) => {
                                            if (!cardId)
                                                return;
