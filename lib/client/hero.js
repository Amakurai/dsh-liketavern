...
export function TavernHeroCharacter(props) {
    ...
    return (_jsxs("div", { ref: dockRef, "data-tavern-hero-root": "", className: "dsh-tavern-ui", children: [chipHost ? createPortal(chip, chipHost) : chip, error && _jsx("div", { className: "dsh-tavern-hero-error", children: error }), binding && (_jsxs("div", { className: "dsh-tavern-hero-preview dsh-tavern-rise", tabIndex: variants.length > 1 ? 0 : undefined, onKeyDown: (e) => {
                ...
                }, children: [_jsxs("div", { className: "dsh-tavern-hero-previewHead", children: [_jsx(Avatar, { url: avatar, name: chipLabel, size: 20 }), _jsx("div", { className: "dsh-tavern-hero-previewName", children: chipLabel })] }), greetingText ? (_jsx("div", { className: "dsh-tavern-hero-previewText", children: greetingText })) : hasAnyGreeting ? (_jsx("div", { className: "dsh-tavern-hero-previewText", children: "\u5F53\u524D\u8FD9\u6761\u5F00\u573A\u767D\u4E3A\u7A7A\uFF0C\u53EF\u5207\u6362\u53D8\u4F53\u3002" })) : (_jsx("div", { className: "dsh-tavern-hero-previewText", children: "\u8BE5\u89D2\u8272\u6CA1\u6709\u5F00\u573A\u767D\u3002\u53EF\u4EE5\u76F4\u63A5\u5728\u4E0B\u65B9\u8F93\u5165\u3002" })), variants.length > 1 && (_jsxs("div", { className: "dsh-tavern-hero-swipe", children: [_jsx("button", { type: "button", className: "dsh-tavern-hero-swipeBtn", disabled: busy, title: "\u4E0A\u4E00\u6761\u5F00\u573A\u767D", onClick: () => void swipe(-1), children: _jsx(IconChevronLeftOutline14, {}) }), _jsxs("span", { className: "dsh-tavern-hero-swipeIdx", children: [greetingIndex + 1, "/", variants.length] }), _jsx("button", { type: "button", className: "dsh-tavern-hero-swipeBtn", disabled: busy, title: "\u4E0B\u4E00\u6761\u5F00\u573A\u767D", onClick: () => void swipe(1), children: _jsx(IconChevronRightOutline14, {}) })] })), _jsx("div", { className: "dsh-tavern-hero-actions", children: _jsx(Btn, { primary: true, size: "md", disabled: busy, onClick: () => void startConversation(), children: "\u5F00\u59CB\u5BF9\u8BDD" }) })] }))] }));
}
