    ...
    return (_jsxs(Dialog, { open: true, width: "xl", title: t('characters.detail.title', { name: detail?.name ?? cardId }), onClose: props.onClose, children: [toast.node, state.status === 'loading' && (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: 8 }, children: [_jsx(Skeleton, { height: 48 }), _jsx(Skeleton, { height: 14, width: "60%" }), _jsx(Skeleton, { height: 90 })] })), state.status === 'error' && _jsx(Err, { message: state.message }), detail && (_jsxs("div", { className: "dsh-tavern-dialogStack dsh-tavern-scroll", style: { maxHeight: '65vh', overflow: 'auto', fontSize: 13 }, children: [_jsxs("div", { className: "dsh-tavern-panelCard", style: { flexDirection: 'row', alignItems: 'center', gap: 14 }, children: [_jsx(CardAvatar, { remote: remote, cardId: cardId, name: detail.name, size: 52 }), _jsxs("div", { style: { flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: 8 }, children: [_jsx(Field, { label: t('characters.detail.displayName'), children: _jsx("input", { className: "dsh-tavern-input", style: { width: '100%' }, value: detail.name, onChange: (e) => set({ name: e.target.value }) }) }), _jsxs(Muted, { children: [detail.spec, " \u00B7 v", detail.characterVersion || '?', " \u00B7 ", detail.creator || t('characters.detail.unknownCreator'), detail.hasCharacterBook
                                            ...
                                            depthPrompt: e.target.value.trim()
                                                ...
                                                : null,
                                                    ...
                                                    ] }) })] })) : null] })] }), _jsxs("div", { className: "dsh-tavern-panelCard", children: [_jsx("div", { className: "dsh-tavern-groupHead", children: t('characters.detail.groupMetadata') }), _jsx(LabeledArea, { label: t('characters.detail.creatorNotes'), value: detail.creatorNotes, onChange: (v) => set({ creatorNotes: v }) }), _jsxs("div", { className: "dsh-tavern-fieldRow", children: [_jsx(Field, { label: t('characters.detail.creator'), children: _jsx("input", { className: "dsh-tavern-input", value: detail.creator, onChange: (e) => set({ creator: e.target.value }) }) }), _jsx(Field, { label: t('characters.detail.version'), children: _jsx("input", { className: "dsh-tavern-input", value: detail.characterVersion, onChange: (e) => set({ characterVersion: e.target.value }) }) })] }), _jsx(Field, { label: t('characters.detail.tags'), children: _jsx("input", { className: "dsh-tavern-input", style: { width: '100%' }, value: detail.tags.join(', '), onChange: (e) => set({ tags: e.target.value.split(/[，,]/).map((s) => s.trim()).filter(Boolean) }) }) })] }), _jsx(Err, { message: error }), _jsxs("div", { className: "dsh-tavern-footActions", style: { marginTop: 2 }, children: [_jsx(IconBtn, { label: t('characters.detail.exportPng'), disabled: busy, onClick: () => void exportCard('png'), children: _jsx(IconDownloadOutline16, {}) }), interactiveHtml !== null && _jsx(Btn, { size: "md", onClick: () => setCardOpen(true), children: t('interactive.open') }), _jsx("span", { className: "dsh-tavern-footSpacer" }), _jsx(Btn, { size: "md", disabled: busy, onClick: () => void exportCard('json'), children: t('characters.detail.exportJson') }), _jsx(Btn, { primary: true, size: "md", disabled: busy, onClick: () => void save(), children: t('action.save') })] })] })), cardOpen && interactiveHtml !== null && (_jsx(Dialog, { open: true, width: "lg", title: t('characters.detail.interactiveTitle', { name: detail?.name ?? '' }), onClose: () => setCardOpen(false), children: _jsx("iframe", { sandbox: "allow-scripts", srcDoc: withCsp(interactiveHtml), title: t('characters.detail.interactiveFrame'), style: { width: '100%', height: '60vh', border: '1px solid var(--dsw-alias-border-l2, rgba(128,128,128,.25))', borderRadius: 16, background: 'var(--dsw-alias-bg-base, #111)' } }) }))] }));
}
export function CharactersSection(props) {
    ...
    return (_jsxs(Section, { title: t('section.characters'), description: t('characters.section.desc'), children: [toast.node, _jsxs("div", { className: "dsh-tavern-toolbar", children: [_jsx(FileBtn, { accept: ".png,.json", disabled: busy, onFile: (file) => void onImportFile(file), children: t('characters.importFile') }), _jsx(Btn, { size: "md", disabled: busy, onClick: () => setCreating(true), children: t('characters.newCard') }), _jsx(Btn, { size: "md", onClick: reload, disabled: busy, children: t('action.refresh') }), items.length >= 5 && (_jsx(SearchInput, { label: t('characters.searchLabel'), value: query, onChange: setQuery, placeholder: t('characters.searchPlaceholder'), width: 220 }))] }), state.status === 'loading' && (_jsxs("div", { className: "dsh-tavern-charGrid", children: [_jsx(Skeleton, { height: 198, radius: 18 }), _jsx(Skeleton, { height: 198, radius: 18 }), _jsx(Skeleton, { height: 198, radius: 18 })] })), state.status === 'error' && _jsx(Err, { message: state.message }), _jsx(Err, { message: error }), items.length === 0 && state.status === 'ready' && (_jsxs("div", { className: "dsh-tavern-empty", children: [_jsx("div", { className: "dsh-tavern-emptyIcon", children: _jsx(IconUserOutline16, { size: 32 }) }), _jsx("div", { className: "dsh-tavern-emptyTitle", children: t('hero.noCharacters') }), _jsx("div", { className: "dsh-tavern-emptyDesc", children: t('characters.emptyDesc') })] })), q !== '' && filtered.length === 0 && state.status === 'ready' && (_jsx(SearchEmpty, { what: t('characters.what'), query: query.trim(), onClear: () => setQuery('') })), _jsx("div", { className: "dsh-tavern-charGrid", children: filtered.map((item) => (_jsx(CharacterCard, { remote: remote, item: item, busy: busy, onOpen: setDetailId, onDelete: setToDelete }, item.cardId))) }), detailId && (_jsx(CharacterDetailDialog, { remote: remote, cardId: detailId, onClose: () => setDetailId(null), onSaved: reload })), pending && (_jsx(Dialog, { open: true, title: t('characters.importBook.title'), description: pending.preview.characterBookName
                    ...
                    : t('characters.importBook.desc', { name: pending.preview.name, count: pending.preview.entryCount }), onClose: () => setPending(null), footer: _jsxs("div", { className: "dsh-tavern-modalActions", children: [_jsx(Button, { type: "button", variant: "outline", size: "md", disabled: busy, onClick: () => void doImport(pending.name, pending.dataBase64, false), children: t('characters.importBook.skip') }), _jsx(Button, { type: "button", variant: "primary", size: "md", disabled: busy, onClick: () => void doImport(pending.name, pending.dataBase64, true), children: t('characters.importBook.import') })] }), children: _jsx("p", { style: { margin: 0, fontSize: 13, lineHeight: '20px', color: 'var(--dsw-alias-label-secondary)' }, children: t('characters.importBook.skipNote') }) })), _jsx(ConfirmDialog, { open: toDelete !== null, title: t('characters.delete.title'), description: toDelete ? t('characters.delete.desc', { name: toDelete.name }) : '', confirmLabel: t('action.delete'), danger: true, busy: busy, onCancel: () => setToDelete(null), onConfirm: () => void onDelete() }), _jsx(Dialog, { open: creating, title: t('characters.create.title'), description: t('characters.create.desc'), onClose: () => setCreating(false), footer: _jsxs("div", { className: "dsh-tavern-modalActions", children: [_jsx(Btn, { size: "md", onClick: () => setCreating(false), children: t('action.cancel') }), _jsx(Btn, { primary: true, size: "md", disabled: busy || !newName.trim(), onClick: () => {
                            ...
                            }, children: t('characters.create.confirm') })] }), children: _jsx("input", { className: "dsh-tavern-input", style: { width: '100%', height: 36, borderRadius: 8, padding: '0 10px', fontSize: 13, boxSizing: 'border-box' }, value: newName, placeholder: t('characters.create.namePlaceholder'), onChange: (e) => setNewName(e.target.value) }) })] }));
}
