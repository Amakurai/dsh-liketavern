...
export function LorebookEditor(props) {
    ...
    return (_jsxs("div", { children: [_jsxs("div", { className: "dsh-tavern-toolbar", children: [_jsx(Btn, { size: "md", onClick: askClose, children: target.kind === 'chat' ? '关闭' : '返回列表' }), _jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsx("div", { className: "dsh-tavern-cardName", style: { fontSize: 15 }, children: target.name }), _jsxs("div", { className: "dsh-tavern-editorMeta", children: [_jsxs(Muted, { children: [targetKindLabel(target.kind), " \u00B7 ", entries.length, " \u6761 \u00B7 \u542F\u7528 ", enabledCount, constantCount > 0 ? ` · 常驻 ${constantCount}` : ''] }), dirty ? _jsx(Badge, { accent: true, children: "\u672A\u4FDD\u5B58" }) : null] })] }), _jsx(Btn, { size: "md", onClick: addEntry, children: "\u65B0\u5EFA\u6761\u76EE" }), _jsx(Btn, { primary: true, size: "md", disabled: busy || !dirty, onClick: () => void save(), children: "\u4FDD\u5B58" })] }), _jsx(Err, { message: error }), _jsxs("div", { className: "dsh-tavern-search", style: { margin: '10px 0 12px' }, children: [_jsx("span", { className: "dsh-tavern-searchIcon", children: _jsx(IconSearchOutline16, {}) }), _jsx("input", { value: query, placeholder: "\u641C\u7D22\u6761\u76EE\u540D\u3001\u5173\u952E\u8BCD\u6216\u6B63\u6587\u2026", onChange: (e) => {
