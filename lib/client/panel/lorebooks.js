...
export function LorebooksSection(props) {
    ...
    if (opened) {
        return (_jsxs(Section, { title: t('section.lorebooks'), description: t('lorebooks.editorDesc'), children: [toast.node, _jsx(LorebookEditor, { target: opened.target, entries: opened.entries, onClose: () => setOpened(null), onSaved: () => {
    ...
    return (_jsxs(Section, { title: t('section.lorebooks'), description: t('lorebooks.listDesc'), children: [toast.node, _jsxs("div", { className: "dsh-tavern-toolbar", children: [_jsx(FileBtn, { accept: ".json", disabled: busy, onFile: (file) => void onImportFile(file), children: t('lorebooks.importJson') }), _jsx(Btn, { size: "md", disabled: busy, onClick: () => setCreating(true), children: t('lorebooks.newEmpty') }), _jsx(Btn, { size: "md", onClick: () => {
                            reload();
                            chars.reload();
                        }, disabled: busy, children: t('action.refresh') }), totalBooks >= 5 && (_jsx(SearchInput, { label: t('lorebooks.searchLabel'), value: query, onChange: setQuery, placeholder: t('lorebooks.searchPlaceholder'), width: 220 }))] }), (state.status === 'loading' || opening) && (_jsxs("div", { className: "dsh-tavern-list", children: [_jsx(Skeleton, { height: 70, radius: 16 }), _jsx(Skeleton, { height: 70, radius: 16 }), _jsx(Skeleton, { height: 70, radius: 16 })] })), state.status === 'error' && _jsx(Err, { message: state.message }), _jsx(Err, { message: error }), q !== '' && shownCharBooks.length === 0 && shownNames.length === 0 && state.status === 'ready' && chars.state.status === 'ready' && (_jsx(SearchEmpty, { what: t('section.lorebooks'), query: query.trim(), onClear: () => setQuery('') })), shownCharBooks.length > 0 && (_jsxs(_Fragment, { children: [_jsx("div", { className: "dsh-tavern-groupHead", children: t('lorebooks.groupEmbedded') }), _jsx("div", { className: "dsh-tavern-list", children: shownCharBooks.map((item) => (_jsxs("div", { className: "dsh-tavern-tile", ...clickableProps(() => void openCharacter(item)), children: [_jsx("span", { className: "dsh-tavern-tileIcon", children: _jsx(IconFolderOpenOutline16, { size: 18 }) }), _jsxs("div", { className: "dsh-tavern-tileMain", children: [_jsxs("div", { className: "dsh-tavern-tileTitleRow", children: [_jsx("span", { className: "dsh-tavern-tileName", children: item.characterBookName || item.name }), _jsx(Badge, { children: t('lorebooks.badgeEmbedded') })] }), _jsx("span", { className: "dsh-tavern-tileSub", children: typeof item.characterBookEntryCount === 'number' && item.characterBookEntryCount > 0
                                                ? t('lorebooks.fromCharacterWithCount', { name: item.name, count: item.characterBookEntryCount })
                                                : t('lorebooks.fromCharacter', { name: item.name }) })] }), _jsxs("div", { className: "dsh-tavern-tileActions", children: [_jsx(IconBtn, { label: t('lorebooks.editEntries'), onClick: () => void openCharacter(item), children: _jsx(IconEditOutline16, {}) }), _jsx(IconBtn, { label: t('lorebooks.deleteEmbedded'), danger: true, onClick: () => setToDeleteEmbedded(item), children: _jsx(IconTrashOutline16, {}) })] })] }, item.cardId))) })] })), _jsx("div", { className: "dsh-tavern-groupHead", children: t('lorebooks.groupLibrary') }), shownNames.length === 0 && state.status === 'ready' ? (q === '' ? (_jsxs("div", { className: "dsh-tavern-empty", children: [_jsx("div", { className: "dsh-tavern-emptyIcon", children: _jsx(IconFolderOpenOutline16, { size: 32 }) }), _jsx("div", { className: "dsh-tavern-emptyTitle", children: t('lorebooks.emptyTitle') }), _jsx("div", { className: "dsh-tavern-emptyDesc", children: charBooks.length > 0 ? t('lorebooks.emptyDescEmbeddedAbove') : t('lorebooks.emptyDesc') })] })) : null) : (_jsx("div", { className: "dsh-tavern-list", children: shownNames.map((name) => (_jsxs("div", { className: "dsh-tavern-tile", ...clickableProps(() => void openLibrary(name)), children: [_jsx("span", { className: "dsh-tavern-tileIcon", children: _jsx(IconFolderOpenOutline16, { size: 18 }) }), _jsxs("div", { className: "dsh-tavern-tileMain", children: [_jsxs("div", { className: "dsh-tavern-tileTitleRow", children: [_jsx("span", { className: "dsh-tavern-tileName", children: name }), _jsx(Badge, { children: t('lorebooks.badgeLibrary') })] }), _jsx("span", { className: "dsh-tavern-tileSub", children: t('lorebooks.libraryFileSub') })] }), _jsxs("div", { className: "dsh-tavern-tileActions", children: [_jsx(IconBtn, { label: t('lorebooks.editEntries'), onClick: () => void openLibrary(name), children: _jsx(IconEditOutline16, {}) }), _jsx(IconBtn, { label: t('lorebooks.exportJson'), onClick: () => void exportBook(name), children: _jsx(IconDownloadOutline16, {}) }), _jsx(IconBtn, { label: t('lorebooks.deleteBook'), danger: true, onClick: () => setToDelete(name), children: _jsx(IconTrashOutline16, {}) })] })] }, name))) })), _jsx(ConfirmDialog, { open: toDelete !== null, title: t('lorebooks.confirmDeleteTitle'), description: toDelete ? t('lorebooks.confirmDeleteDesc', { name: toDelete }) : '', confirmLabel: t('action.delete'), danger: true, onCancel: () => setToDelete(null), onConfirm: () => void remove() }), _jsx(ConfirmDialog, { open: toDeleteEmbedded !== null, title: t('lorebooks.confirmDeleteEmbeddedTitle'), description: toDeleteEmbedded
                    ...
                    : '', confirmLabel: t('action.delete'), danger: true, onCancel: () => setToDeleteEmbedded(null), onConfirm: () => void removeEmbedded() }), _jsx(Dialog, { open: creating, title: t('lorebooks.createTitle'), description: t('lorebooks.createDesc'), onClose: () => setCreating(false), footer: _jsxs("div", { className: "dsh-tavern-modalActions", children: [_jsx(Btn, { size: "md", onClick: () => setCreating(false), children: t('action.cancel') }), _jsx(Btn, { primary: true, size: "md", disabled: busy, onClick: () => void createEmpty(), children: t('lorebooks.create') })] }), children: _jsx("input", { className: "dsh-tavern-input", style: { width: '100%', height: 36, borderRadius: 8, padding: '0 10px', fontSize: 13, boxSizing: 'border-box' }, value: newName, placeholder: t('lorebooks.namePlaceholder'), onChange: (e) => setNewName(e.target.value) }) })] }));
}
