...
function LorebooksSectionContent(props) {
    ...
    return (_jsxs(Section, { title: t('section.lorebooks'), description: t('lorebooks.listDesc'), children: [toast.node, createGuard.confirmation, _jsxs("div", { className: "dsh-tavern-toolbar", children: [_jsx(FileBtn, { accept: ".json", disabled: busy, onFile: (file) => void onImportFile(file), children: t('lorebooks.importJson') }), _jsx(Btn, { size: "md", disabled: busy, onClick: () => setCreating(true), children: t('lorebooks.newEmpty') }), _jsx(Btn, { size: "md", onClick: () => {
                            reload();
                            chars.reload();
