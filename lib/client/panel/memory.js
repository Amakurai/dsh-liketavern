...
const DELTA_TYPE_LABEL = { add: '新增', update: '更新', invalidate: '作废' };
...
export function MemorySection(props) {
    ...
    return (_jsxs(Section, { title: "\u8BB0\u5FC6\u4E0E\u4E16\u754C\u72B6\u6001", description: "\u6309\u89D2\u8272\u67E5\u770B\u548C\u7F16\u8F91\u957F\u671F\u8BB0\u5FC6\u3001\u4E16\u754C\u72B6\u6001\u53D8\u5316\u5C42\u3001\u89D2\u8272\u7B14\u8BB0 journal.md\u3002", children: [toast.node, _jsx(SettingsRow, { title: "\u89D2\u8272", description: "\u9009\u62E9\u8981\u67E5\u770B\u7684\u89D2\u8272\u5361\u5DE5\u4F5C\u533A\u3002", children: _jsx(Select, { size: "md", value: cardId, onChange: setCardId, options: [{ value: '', label: '（选择角色）' }, ...charItems.map((c) => ({ value: c.cardId, label: c.name }))] }) }), _jsx(Err, { message: error }), cardId && (_jsxs(_Fragment, { children: [_jsxs("div", { style: { display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 10, margin: '10px 0 14px' }, children: [_jsxs("div", { className: "dsh-tavern-filters", children: [_jsxs("button", { type: "button", className: "dsh-tavern-chip", "data-active": tab === 'memory' ? 'true' : 'false', onClick: () => setTab('memory'), children: ["\u8BB0\u5FC6\uFF08", memoryItems.length, "\uFF09"] }), _jsxs("button", { type: "button", className: "dsh-tavern-chip", "data-active": tab === 'delta' ? 'true' : 'false', onClick: () => setTab('delta'), children: ["\u4E16\u754C\u72B6\u6001\uFF08", deltaItems.length, "\uFF09"] }), _jsx("button", { type: "button", className: "dsh-tavern-chip", "data-active": tab === 'journal' ? 'true' : 'false', onClick: () => setTab('journal'), children: "\u89D2\u8272\u7B14\u8BB0" })] }), _jsx("span", { style: { flex: 1 } }), tab === 'memory' && _jsx(Btn, { onClick: () => void compress(), children: "\u5F52\u5E76\u6700\u65E7\u4E00\u6279" }), tab === 'delta' && _jsx(Btn, { onClick: () => void exportBook(), children: "\u5BFC\u51FA\u5408\u5E76\u540E\u7684\u4E16\u754C\u4E66" })] }), tab === 'memory' && (_jsxs("div", { className: "dsh-tavern-list", children: [memories.state.status === 'loading' && (_jsxs(_Fragment, { children: [_jsx(Skeleton, { height: 72 }), _jsx(Skeleton, { height: 72 }), _jsx(Skeleton, { height: 72 })] })), memories.state.status === 'error' && _jsx(Err, { message: memories.state.message }), memoryItems.length === 0 && memories.state.status === 'ready' && (_jsxs("div", { className: "dsh-tavern-empty is-compact", children: [_jsx("div", { className: "dsh-tavern-emptyTitle", children: "\u6682\u65E0\u8BB0\u5FC6" }), _jsx("div", { className: "dsh-tavern-emptyDesc", children: "\u8BA9\u6A21\u578B\u7528 tavern_memory_write \u5199\u5165\uFF0C\u6216\u5728\u4E0B\u65B9\u624B\u52A8\u6DFB\u52A0\u3002" })] })), memoryItems.map((m) => (_jsxs("div", { className: "dsh-tavern-memo", children: [_jsxs("div", { className: "dsh-tavern-memoHead", children: [_jsx(Badge, { children: m.id }), m.archived ? _jsx(Badge, { children: "\u5DF2\u5F52\u6863" }) : null, m.tags.map((tag) => (_jsx(Badge, { children: tag }, tag))), _jsx("span", { className: "dsh-tavern-memoMeta", children: m.updated }), _jsxs("span", { className: "dsh-tavern-memoActions", children: [_jsx(IconBtn, { label: editingId === m.id ? '收起编辑' : '编辑', onClick: () => setEditingId(editingId === m.id ? null : m.id), children: _jsx(IconEditOutline16, {}) }), _jsx(IconBtn, { label: "\u5220\u9664\u8BB0\u5FC6", danger: true, onClick: () => void deleteMemory(m.id), children: _jsx(IconTrashOutline16, {}) })] })] }), _jsx("pre", { className: "dsh-tavern-memoBody dsh-tavern-scroll", children: m.body }), editingId === m.id && (_jsx(MemoryEditor, { remote: remote, cardId: cardId, entry: m, onDone: () => {
                                            setEditingId(null);
                                            memories.reload();
                                        } }))] }, m.id))), _jsxs("div", { className: "dsh-tavern-memo is-compose", children: [_jsx("textarea", { className: "dsh-tavern-input dsh-tavern-textarea", style: { minHeight: 60 }, placeholder: "\u65B0\u589E\u8BB0\u5FC6\u2026", value: newBody, onChange: (e) => setNewBody(e.target.value) }), _jsx("div", { style: { display: 'flex', justifyContent: 'flex-end' }, children: _jsx(Btn, { primary: true, disabled: !newBody.trim(), onClick: () => void addMemory(), children: "\u6DFB\u52A0\u8BB0\u5FC6" }) })] })] })), tab === 'delta' && (_jsxs("div", { className: "dsh-tavern-list", children: [deltas.state.status === 'loading' && (_jsxs(_Fragment, { children: [_jsx(Skeleton, { height: 72 }), _jsx(Skeleton, { height: 72 }), _jsx(Skeleton, { height: 72 })] })), deltas.state.status === 'error' && _jsx(Err, { message: deltas.state.message }), deltaItems.map((d) => (_jsxs("div", { className: `dsh-tavern-memo${d.revoked ? ' is-revoked' : ''}`, children: [_jsxs("div", { className: "dsh-tavern-memoHead", children: [_jsxs(Badge, { children: ["#", d.id] }), _jsx(Badge, { danger: d.type === 'invalidate', children: DELTA_TYPE_LABEL[d.type] }), d.ref ? _jsxs(Badge, { children: ["\u2192 ", d.ref] }) : null, d.revoked ? _jsx(Badge, { danger: true, children: "\u5DF2\u64A4\u9500" }) : null, _jsx("span", { className: "dsh-tavern-memoMeta", children: d.ts }), !d.revoked && (_jsx("span", { className: "dsh-tavern-memoActions", children: _jsx(Btn, { size: "sm", onClick: () => void revoke(d.id), children: "\u64A4\u9500" }) }))] }), _jsx("pre", { className: "dsh-tavern-memoBody dsh-tavern-scroll", children: d.content })] }, d.id))), deltaItems.length === 0 && deltas.state.status === 'ready' && (_jsxs("div", { className: "dsh-tavern-empty is-compact", children: [_jsx("div", { className: "dsh-tavern-emptyTitle", children: "\u6682\u65E0\u4E16\u754C\u72B6\u6001\u53D8\u5316" }), _jsx("div", { className: "dsh-tavern-emptyDesc", children: "\u6A21\u578B\u7ECF tavern_worldstate_update \u5199\u5165\uFF0C\u6216\u5728\u4E0B\u65B9\u624B\u52A8\u6DFB\u52A0\u3002" })] })), _jsxs("div", { className: "dsh-tavern-memo is-compose", children: [_jsxs("div", { className: "dsh-tavern-fieldRow", children: [_jsxs("label", { className: "dsh-tavern-field", children: [_jsx("span", { className: "dsh-tavern-fieldLabel", children: "\u7C7B\u578B" }), _jsx(Select, { size: "md", value: deltaType, onChange: (v) => setDeltaType(v), options: [
                                                            { value: 'add', label: '新增' },
