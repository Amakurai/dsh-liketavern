...
function EntryEditor(props) {
    ...
    return (_jsxs("div", { className: "dsh-tavern-entry", children: [_jsxs("div", { style: { display: 'flex', gap: 10, alignItems: 'center', flexWrap: 'wrap', padding: '12px 16px 8px' }, children: [_jsx(Toggle, { checked: entry.enabled, onChange: (enabled) => set({ enabled }), title: entry.enabled ? '关闭此条目' : '启用此条目' }), _jsx("input", { className: "dsh-tavern-input", style: { width: 160 }, value: entry.name, placeholder: "\u540D\u79F0", onChange: (e) => set({ name: e.target.value }) }), _jsx(Select, { value: entry.role, onChange: (v) => set({ role: v }), options: [
