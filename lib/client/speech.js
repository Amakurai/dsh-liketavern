...
function SpeechBubbleSession(props) {
    ...
    const loaded = useLoader(() => remote.renderOutputText({ sessionId, text: rawText, messageId: props.messageId }), [sessionId, rawText, props.messageId, props.interactiveCards], Boolean(rawText) && !streaming);
