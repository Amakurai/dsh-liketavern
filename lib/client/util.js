...
export function Btn(props) {
    return (_jsx(Button, { type: "button", className: "dsh-tavern-btn", variant: props.primary ? 'primary' : 'outline', size: props.size ?? 'sm', disabled: props.disabled, title: props.title, onClick: (e) => {
            e.stopPropagation();
            props.onClick();
...
export function Tabs(props) {
    ...
    return (_jsx("div", { className: `dsh-tavern-navPills${props.size === 'sm' ? ' is-sub' : ''}`, role: "tablist", "aria-label": props.label, onKeyDown: (e) => {
