...
export function Dialog(props) {
    return (_jsx(Modal, { open: props.open, onClose: props.onClose, title: props.title, description: props.description, closeLabel: "\u5173\u95ED", footer: props.footer, contentClassName: props.width === 'md' ? 'dsh-tavern-modal-md' : props.width === 'lg' ? 'dsh-tavern-modal-lg' : undefined, children: _jsx("div", { className: "dsh-tavern-ui dsh-tavern-modalBody", children: props.children }) }));
}
