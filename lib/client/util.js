    ...
    const widthClass = props.width === 'md'
        ...
        : props.width === 'lg'
            ...
            : props.width === 'xl'
                ? 'dsh-tavern-modal-xl'
                : '';
    return (_jsx(Modal, { open: props.open, onClose: props.onClose, title: props.title, description: props.description, closeLabel: t('action.close'), footer: props.footer, contentClassName: `dsh-tavern-modalContent${widthClass ? ` ${widthClass}` : ''}`, children: _jsx("div", { className: "dsh-tavern-ui dsh-tavern-modalBody", children: props.children }) }));
}
