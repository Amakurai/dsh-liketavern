 ...
 */
function wrapCardDocument(html, trustedHead, fullDocument) {
...
function hasCardDocumentShell(html) {
 ...
 */
function needsCardLibraries(html, options) {
