...
export declare const WISelectiveLogic: {
    readonly AndAny: 0;
    readonly NotAll: 1;
    readonly NotAny: 2;
    readonly AndAll: 3;
...
export declare const WIPosition: {
    readonly BeforeCharDefs: 0;
    readonly AfterCharDefs: 1;
    readonly AuthorNoteTop: 2;
    readonly AuthorNoteBottom: 3;
    readonly AtDepth: 4;
    readonly BeforeExampleMessages: 5;
    readonly AfterExampleMessages: 6;
    readonly Outlet: 7;
};
...
export declare const EMPTY_TIMER_STATE: WITimerState;
...
export declare const Marker: {
    ...
    readonly WorldInfoBefore: "worldInfoBefore";
    readonly WorldInfoAfter: "worldInfoAfter";
    readonly CharDescription: "charDescription";
    readonly CharPersonality: "charPersonality";
    readonly Scenario: "scenario";
    readonly DialogueExamples: "dialogueExamples";
    readonly PersonaDescription: "personaDescription";
    /** 本插件新增：检索记忆注入点。 */
...
export type PresetSamplingSettings = Partial<Pick<SamplingSettings, 'temperature' | 'topP' | 'maxTokens' | 'stop' | 'presencePenalty' | 'frequencyPenalty'>>;
