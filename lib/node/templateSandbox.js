...
import { TEMPLATE_REPLAY_LIMIT } from '../core/templateReplay.js';
...
export class TemplateSandbox {
    ...
    replay() {
        ...
        const replay = { version: 2, context: this.initialContext, operations: this.operations, variables, messageVariablesHash: this.hash(this.messageVariables()),
