...
export const zh = {
  ...
  'actions.editUserHint': '保存后会创建新分支，并从这一层重新生成回复。原会话保留。',
  'actions.editAiHint': '保存后会创建新分支，撤销这一层及后续的记忆和状态变更，不自动重新生成回复。原会话保留。',
  'actions.saving': '保存中…',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'actions.editUserHint': 'Saving creates a new branch and regenerates the reply from this floor. The original conversation is preserved.',
  'actions.editAiHint': 'Saving creates a new branch and rolls back memory and state changes from this floor onward, without regenerating the reply. The original conversation is preserved.',
