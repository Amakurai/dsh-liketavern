    ...
    parameters: [
      {
        ...
        codec: { mode: 'strict' as const, typeSymbol: `dsh-tavern/types#${method}Request`, schema: def.req },
      },
    ],
    result: { mode: 'strict' as const, typeSymbol: `dsh-tavern/types#${method}Result`, schema: def.value },
  }
}
