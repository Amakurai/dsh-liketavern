...
import { array, boolean, enum as enum_, looseObject, maxLength, minLength, nullable, number, optional, string, unknown } from 'zod/mini'
...
export function parseStoredPreset(value: unknown): PromptPreset {
  const { helperSettings, ...preset } = storedPresetSchema.parse(value)
