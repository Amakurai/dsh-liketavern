...
beforeEach(async()=>{
  ...
  const events=[{type:'turn/start',seq:0,time:0,data:{turn:1}},{type:'assistant/message',seq:1,time:0,data:{stream: [], turn:1,step:1,message:createAssistantMessage({content:[{type:'text',text:'工厂消息'}]})}},{type:'turn/end',seq:2,time:0,data:{turn:1,reason:{kind:'completed'}}}] as unknown as SessionEvent[]
